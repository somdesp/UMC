(function () {
    'use strict'
    MeHelp.controller("chatController", function ($scope, $rootScope, signalR, Flash) {
        ...
        $scope.SendPrivateMessage = function () {
            // //debugger;
            signalR.SendPrivateMessage(ModelUsuario.Id,$scope.UserInPrivateChat.ConnectionId, $scope.pvtmessage);
            $scope.pvtmessage = '';
        }
        $scope.OnlineUsers = [];
